...
/* harmony import */ var _static_scroller_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../static/scroller.js */ "./static/scroller.js");
/* harmony import */ var _static_scroller_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_static_scroller_js__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _game_index__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./game/index */ "./src/component/game/index.ts");
...
const App = () => {
    const [rustFuncsObject, setFuncs] = react__WEBPACK_IMPORTED_MODULE_0__["useState"](0);
    const setRustFunctions = () => __awaiter(undefined, void 0, void 0, function* () {
        const rustFuncsObject = yield _static_scroller_js__WEBPACK_IMPORTED_MODULE_1___default.a;
        setFuncs(() => rustFuncsObject);
    });
    react__WEBPACK_IMPORTED_MODULE_0__["useEffect"](() => {
        setRustFunctions();
    }, []);
    return (react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("div", null, (rustFuncsObject === 0) ?
        (null)
        :
            (react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_game_index__WEBPACK_IMPORTED_MODULE_2__["GameContainer"], { rustFuncs: rustFuncsObject }))));
};


/***/ }),

/***/ "./src/component/game/gameContainer.tsx":
/*!**********************************************!*\
  !*** ./src/component/game/gameContainer.tsx ***!
  \**********************************************/
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _gameContainerChild__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./gameContainerChild */ "./src/component/game/gameContainerChild.tsx");


const GameContainer = props => {
    console.log(props.rustFuncs.hash(5));
    return (react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_gameContainerChild__WEBPACK_IMPORTED_MODULE_1__["GameContainerChild"], { deh: props.rustFuncs }, "hi"));
};


/***/ }),

/***/ "./src/component/game/gameContainerChild.tsx":
/*!***************************************************!*\
  !*** ./src/component/game/gameContainerChild.tsx ***!
  \***************************************************/
/*! exports provided: GameContainerChild */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "GameContainerChild", function() { return GameContainerChild; });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);

const GameContainerChild = props => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _gameContainer__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./gameContainer */ "./src/component/game/gameContainer.tsx");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "GameContainer", function() { return _gameContainer__WEBPACK_IMPORTED_MODULE_0__["GameContainer"]; });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _App__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./App */ "./src/component/App.tsx");
...
/* harmony import */ var _component_index__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./component/index */ "./src/component/index.ts");



react_dom__WEBPACK_IMPORTED_MODULE_1__["render"](react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_component_index__WEBPACK_IMPORTED_MODULE_2__["App"], null), document.getElementById("root"));
...
(function( root, factory ) {
    ...
    return (function( module_factory ) {
        ...
        if( typeof window === "undefined" && typeof process === "object" ) {
            ...
            // var wasm_path = path.join( __dirname, "scroller.wasm" );
            // var buffer = fs.readFileSync( wasm_path );
            // var mod = new WebAssembly.Module( buffer );
            // var wasm_instance = new WebAssembly.Instance( mod, instance.imports );
            // return instance.initialize( wasm_instance );
        } else {
            var file = fetch( "scroller.wasm", {credentials: "same-origin"} );
            ...
            return wasm_instance
                .then( function( wasm_instance ) {
                    ...
                    console.log( "Finished loading Rust wasm module 'scroller'" );
                    return exports;
                })
                .catch( function( error ) {
                    console.log( "Error loading Rust wasm module 'scroller':", error );
                    throw error;
                });
        }
    }( function() {
...
Module.STDWEB_PRIVATE.acquire_tmp = function( dummy ) {
    ...
    return {
        ...
        initialize: function( instance ) {
            ...
            Module.exports.hash = function hash(num) {
    return Module.instance.exports.hash(num);
}
;
                Module.exports.derp = function derp() {
    return Module.STDWEB_PRIVATE.acquire_tmp(Module.instance.exports.derp());
}
;
            __web_on_grow();
